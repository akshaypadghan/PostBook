...
<head>
    ...
    <asset:stylesheet src="signUpPage.css"/>
</head>
                ...
                <g:form controller="user" data-toggle="validator">
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control" pattern="[A-Za-z ]*" name="name" id="name"
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input class="form-control" name="userName" pattern="[A-Za-z]*([0-9])*?" id="userName"
                                   minlength="5" placeholder="User Name" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="email" class="form-control"
                                   ...
                                   data-error="that doesn't seem valid email" name="email" id="email"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id="address"
                               placeholder="block 4, st. annes" required>
                    </div>
