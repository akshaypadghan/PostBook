...
<html>
	...
	<body>
		...
		<div id="edit-posts" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${postsInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${postsInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:postsInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${postsInstance?.version}" />
				<fieldset class="form">
